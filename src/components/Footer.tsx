...
export const Footer: FC = () => {
    return (
        <div className="mt-auto">
            <footer className="w-full fixed bottom-0 bg-gradient-to-r from-[#9945FF] to-[#19FB9B] animate-gradient-x">
                <div className="container mx-auto flex flex-row p-4 text-center items-center justify-between">
                <div className="pl-2">
                    ...
                    <a href="https://www.youtube.com/c/SolanaFndn" target="_blank" rel="noopener noreferrer">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="fill-current">
                            <path d="M19.615 3.184c-3.604-.246-11.631-.245-15.23 0-3.897.266-4.356 2.62-4.385 8.816.029 6.185.484 8.549 4.385 8.816 3.6.245 11.626.246 15.23 0 3.897-.266 4.356-2.62 4.385-8.816-.029-6.185-.484-8.549-4.385-8.816zm-10.615 12.816v-8l8 3.993-8 4.007z"></path>
                        </svg>
                    </a>
                    <a href="https://www.facebook.com/solana.foundation" target="_blank" rel="noopener noreferrer">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="fill-current">
